...
function main() {
    if (!/github\.com\/[A-z0-9._-]+\/[A-z0-9._-]+\/compare\/master\.\.\.development\?quick_pull=1$/gi.test(window.location.href)) {
        return;
    }
    ...
    const commitMessages = document.querySelectorAll('div.commit-message > code > a:nth-child(1)');
